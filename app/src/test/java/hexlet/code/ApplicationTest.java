...
class ApplicationTest {
    ...
    void jsonDefaultTest() throws Exception  {
        ...
        String actual = Differ.generate(prefix + "file1.json", prefix + "file2.json");
        assertEquals(expected, actual);
    }
    @Test
    void ymlDefaultTest() throws Exception  {
        String expected = readFile("src/test/resources/fixtures/Stylish");
        String actual = Differ.generate(prefix + "file1.yml", prefix + "file2.yml");
        assertEquals(expected, actual);
    }
    @Test
        void jsonStylishTest() throws Exception  {
        String expected = readFile("src/test/resources/fixtures/Stylish");
        String actual = Differ.generate(prefix + "file1.json", prefix + "file2.json", "stylish");
        assertEquals(expected, actual);
    }
    @Test
    void ymlStylishTest() throws Exception  {
        String expected = readFile("src/test/resources/fixtures/Stylish");
        String actual = Differ.generate(prefix + "file1.yml", prefix + "file2.yml", "stylish");
        assertEquals(expected, actual);
    }
    ...
    void jsonPlainTest() throws Exception  {
        ...
        String actual = Differ.generate(prefix + "file1.json", prefix + "file2.json", "plain");
        assertEquals(expected, actual);
    }
    ...
    void ymlPlainTest() throws Exception  {
        String expected = readFile("src/test/resources/fixtures/Plain");
        String actual = Differ.generate(prefix + "file1.yml", prefix + "file2.yml", "plain");
        assertEquals(expected, actual);
    }
    ...
    void jsonJsonTest() throws Exception  {
        ...
        String actual = Differ.generate(prefix + "file1.json", prefix + "file2.json", "json");
        assertEquals(expected, actual);
    }
    ...
    void ymlJsonTest() throws Exception  {
        String expected = readFile("src/test/resources/fixtures/JSON");
        String actual = Differ.generate(prefix + "file1.yml", prefix + "file2.yml", "json");
        assertEquals(expected, actual);
    }
